                    ...
                    $(this).children("td").each(function (index2)
                    {
                        switch (index2)
                        {
                            ...
                            case 7: campo7 = campo3 * campo4;
                                    if(exentos>0){
                                      sumaiva = ((campo3 * campo4) - campo6)*0;
                                      sumast = 0;

                                      exentot = exentos-descuentos;

                                    }else{
                                      sumaiva = ((campo3 * campo4) - campo6)*0.12;
                                      sumast = campo7-descuentos;
                                      exentot = 0;
                      ...
                      total_iva = sumaiva+total_iva;

                      total_sumas = sumast+total_sumas;


                      total_exentos = exentot + total_exentos;
                      total_descuentos = total_descuentos + descuentos;

                      if(total_sumas >= monto_retencion){
                         iva_retenido = total_sumas * porc_rete;
                         total = ((total_sumas + total_exentos) - iva_retenido) + total_iva;

                      } else {

                         total = (total_sumas + total_exentos) + total_iva;
                      }
                })
