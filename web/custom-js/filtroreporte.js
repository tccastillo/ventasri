...
function buscar_datos()
{
  ...
  var categoria = $("#cbCategoria").val();
    ...
    if(fecha1!="" && fecha2!="" && categoria!="")
    {
        $.ajax({

           type:"GET",
           url:"web/ajax/reload-ventas_filtro.php?fecha1="+fecha1+"&fecha2="+fecha2+"&categoria="+categoria,
      ...
      $.ajax({
           ...
           type:"GET",
           url:"web/ajax/reload-ventas_filtro.php?fecha1=empty&fecha2=empty&categoria=empty",
           success: function(data){
              $('#reload-div').html(data);
           }
