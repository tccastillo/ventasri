...
function Print_Report(Criterio,parameter)
{
      ...
      window.location.href = 'http://localhost:82/ventas/reportes/Corte_Z_Dia.php?day='+parameter;
      ...
      window.location.href = 'http://localhost:82/ventas/reportes/Corte_Z_Mes.php?mes='+parameter;
