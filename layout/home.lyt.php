...
<head>
	...
	<title>Megaxnet - Sus ventas mas fácil</title>
...
<body class="sidebar-xs has-detached-right">
	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<a href="?View=POS" type="button" class="btn bg-pink btn-labeled btn-rounded"><b><i class="icon-store"></i></b> Megaxnet</a>
			<a href="?View=Creditos" type="button" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-credit-card"></i></b> Creditos</a>
			<a href="?View=POS" type="button" class="btn bg-primary btn-labeled btn-rounded"><b><i class="icon-coins"></i></b> Abrir Caja</a>
