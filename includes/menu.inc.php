					...
					<?php  if($tipo_usuario == '1'){ ?>
						...
						<li>
							...
							<ul>
								...
								<li><a href="./?View=Reporteextra">Reporte extra</a></li>
						...
						<!-- Inventario -->
						<li>
							<a href="#"><i class="icon-grid6"></i> <span>Documentos electrónicos</span></a>
							<ul>
								<li><a href="./?View=Documentos">Documentos electrónicos</a></li>
								<li><a href="./?View=Facturacion">Configuración</a></li>
								<li><a href="./?View=Backup">Copia de seguridad</a></li>
							</ul>
						</li>
						<!-- /Inventario -->
					...
					<?php } else { ?>
						...
						<!-- /Acera de -->
						<li>
							<a href="./?View=Acerca-de"><i class="icon-info22"></i> <span> Acerca de Megaxnet </span></a>
						</li>
						<!--Acerca de  -->
