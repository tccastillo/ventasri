<?php
    ...
    $conf["Reporteextra"] = array(
        "file" => "reporteextra.vw.php"
    );
    $conf["Reporte_grafica"] = array(
        "file" => "reportegrafica.vw.php"
    );
    ...
    $conf["Facturacion"] = array(
        "file" => "facturacion.vw.php"
    );

    $conf["Documentos"] = array(
        "file" => "documentos.vw.php"
    );
