...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-02-2023 a las 18:07:42
...
CREATE   PROCEDURE `sp_detalle_imprimir_ticket_venta` (IN `p_idventa` INT(11))  BEGIN
        ...
        SELECT cantidad, substring(nombre_producto,1,40) as descripcion,precio_unitario,producto_exento,descuento,
        if(producto_exento = '1', CONCAT(importe,' E '), CONCAT(importe,' G ')) as importe
        FROM view_ventas
...
CREATE   PROCEDURE `sp_insert_cliente` (IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(8), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2))  BEGIN
...
CREATE   PROCEDURE `sp_insert_detallecompra` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,4), IN `p_exento` DECIMAL(8,2), IN `p_fecha_vencimiento` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE   PROCEDURE `sp_insert_empleado` (IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(8), IN `p_email_empleado` VARCHAR(80))  BEGIN
...
CREATE   PROCEDURE `sp_insert_parametro` (IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_porcentaje_iva` DECIMAL(8,2), IN `p_porcentaje_retencion` DECIMAL(8,2), IN `p_monto_retencion` DECIMAL(8,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))  BEGIN
...
CREATE   PROCEDURE `sp_insert_proveedor` (IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(8), IN `p_numero_nit` VARCHAR(14), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150))  BEGIN
...
CREATE   PROCEDURE `sp_insert_tecnico` (IN `p_tecnico` VARCHAR(150), IN `p_telefono` VARCHAR(8))  BEGIN
...
CREATE   PROCEDURE `sp_insert_tiraje_comprobante` (IN `p_fecha_resolucion` DATE, IN `p_numero_resolucion` VARCHAR(100), IN `p_numero_resolucion_fact` VARCHAR(100), IN `p_serie` VARCHAR(175), IN `p_desde` INT(11), IN `p_hasta` INT(11), IN `p_disponibles` INT(11), IN `p_idcomprobante` INT(11))  BEGIN
...
CREATE   PROCEDURE `sp_insert_usuario` (IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
...
CREATE   PROCEDURE `sp_login_usuario` (IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12))  BEGIN
...
CREATE   PROCEDURE `sp_update_cliente` (IN `p_idcliente` INT(11), IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(8), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `cliente`
...
CREATE   PROCEDURE `sp_update_empleado` (IN `p_idempleado` INT(11), IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(8), IN `p_email_empleado` VARCHAR(80), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `empleado`
...
CREATE   PROCEDURE `sp_update_proveedor` (IN `p_idproveedor` INT(11), IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(8), IN `p_numero_nit` VARCHAR(14), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `proveedor`
...
CREATE   PROCEDURE `sp_update_tecnico` (IN `p_idtecnico` INT(11), IN `p_tecnico` VARCHAR(150), IN `p_telefono` VARCHAR(8), IN `p_estado` TINYINT(1))  BEGIN
	UPDATE `tecnico`
	SET `tecnico` = p_tecnico, `telefono` = p_telefono, `estado` = p_estado
	WHERE `idtecnico` = p_idtecnico;
END$$

CREATE   PROCEDURE `sp_update_tiraje_comprobante` (IN `p_idtiraje` INT(11), IN `p_fecha_resolucion` DATE, IN `p_numero_resolucion` VARCHAR(100), IN `p_numero_resolucion_fact` VARCHAR(100), IN `p_serie` VARCHAR(175), IN `p_desde` INT(11), IN `p_hasta` INT(11), IN `p_disponibles` INT(11), IN `p_idcomprobante` INT(11))  BEGIN
...
CREATE   PROCEDURE `sp_update_usuario` (IN `p_idusuario` INT(11), IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_estado` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
UPDATE `usuario`
...
(1, 'CL00000001', 'WESTERN PHARMACEUTICAL S.A.', '1791248678001', 'CIUDAD', '54620710', 'nfychpas@gmail.com', '', '400.00', 1),
(2, 'CL00000002', 'GINA ALEXANDRA ALVAREZ MEZA', '1205546664', '', '09374839', 'gaam_ginaeacha87@hotmail.com', '', '0.00', 1),
(3, 'CL00000003', 'CONSUMIDOR FINAL', '9999999999999', '', '0000', 'nfychpas@gmail.com', '', '1400.00', 1);
...
INSERT INTO `facturacion` (`id`, `fac_ele`, `certificado`, `clave`, `entidad_cert`) VALUES
(1, 1, '1311218786001.p12', 'MINDIOLA8888', 'SEC_DATA');
...
(1, 'FERRETERIA FERRAN', 'CARMEN VICTORIA MOREIRA RUIZ', '1311218786001', '12.00', '0.00', '0.00', 'PRINCIPAL S/N Y AV JUAN CARLOS ASPIAZU', NULL, 6);
...
(1, '2022-10-31', 'RES 008458148', '2022-1-199999', 'A', 1, 5000, 1, 4993),
(2, '2022-11-15', 'DOS', 'RYMPE', '15UN000000001 1615UN0000001', 100000, 2000000, 2, 1999983);
