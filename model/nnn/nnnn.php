...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_abrir_caja` (IN `p_monto_apertura` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_abrir_inventario` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_anular_apartado` (IN `p_idapartado` INT(11))  BEGIN	
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_anular_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_cerrar_caja` (IN `p_monto_cierre` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_cerrar_caja_manual` (IN `p_id` INT)  BEGIN
	UPDATE caja SET
    estado = 0 WHERE idcaja = p_id;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_cerrar_inventario` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_cerrar_inventario_manual` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_compras_anual` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_anular_compra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_apartados` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_ventas` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_cotizaciones` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_creditos` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_ordenes` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_delete_cotizacion` (IN `p_idcotizacion` INT(11))  BEGIN
DELETE FROM `cotizacion`
WHERE `idcotizacion` = p_idcotizacion;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_apartados_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_historico_precios` (IN `p_idproducto` INT(11))  BEGIN

		SELECT * FROM view_historico_precios WHERE idproducto = p_idproducto;

	END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_precio_mas_bajo` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_delete_ordentaller` (IN `p_idorden` INT(11))  BEGIN
	DELETE FROM `ordentaller`
	WHERE `idorden` = p_idorden;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_delete_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_idproducto` INT(11))  BEGIN
	DELETE FROM `perecedero` WHERE `idproducto` =  p_idproducto
    AND `fecha_vencimiento` = p_fecha_vencimiento;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_fechas_vencimiento` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_historico_caja` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
    IF (p_date = '' AND p_date2 = '') THEN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_apartados_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_corte_z_day` (IN `p_day` DATE)  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_caja_apartado` (IN `p_monto_movimiento` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_compras` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_corte_z_mes` (IN `p_month` VARCHAR(7))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_caja_movimiento` (IN `p_tipo_movimiento` TINYINT(1), IN `p_monto_movimiento` DECIMAL(8,2), IN `p_descripcion_movimiento` VARCHAR(80))  BEGIN
    DECLARE p_idcaja int(11);
    DECLARE p_tipo_comprobante tinyint(1);
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_compras_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_categoria` (IN `p_nombre_categoria` VARCHAR(120))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_cliente` (IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(8), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_comprobante` (IN `p_nombre_comprobante` VARCHAR(75))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_compras_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_currency` (IN `p_CurrencyISO` VARCHAR(3), IN `p_Language` VARCHAR(3), IN `p_CurrencyName` VARCHAR(35), IN `p_Money` VARCHAR(30), IN `p_Symbol` VARCHAR(3))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_empleado` (IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(8), IN `p_email_empleado` VARCHAR(80))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_marca` (IN `p_nombre_marca` VARCHAR(120))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_ordentaller` (IN `p_idcliente` INT(11), IN `p_aparato` VARCHAR(125), IN `p_modelo` VARCHAR(125), IN `p_idmarca` INT(11), IN `p_serie` VARCHAR(125), IN `p_idtecnico` INT(11), IN `p_averia` VARCHAR(200), IN `p_observaciones` VARCHAR(200), IN `p_deposito_revision` DECIMAL(8,2), IN `p_deposito_reparacion` DECIMAL(8,2), IN `p_parcial_pagar` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_ventas_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_parametro` (IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_porcentaje_iva` DECIMAL(8,2), IN `p_porcentaje_retencion` DECIMAL(8,2), IN `p_monto_retencion` DECIMAL(8,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_presentacion` (IN `p_nombre_presentacion` VARCHAR(120), IN `p_siglas` VARCHAR(45))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_proveedor` (IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(8), IN `p_numero_nit` VARCHAR(14), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_consulta_ventas_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_delete_abono` (IN `p_idabono` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_tecnico` (IN `p_tecnico` VARCHAR(150), IN `p_telefono` VARCHAR(8))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_tiraje_comprobante` (IN `p_fecha_resolucion` DATE, IN `p_numero_resolucion` VARCHAR(100), IN `p_numero_resolucion_fact` VARCHAR(100), IN `p_serie` VARCHAR(175), IN `p_desde` INT(11), IN `p_hasta` INT(11), IN `p_disponibles` INT(11), IN `p_idcomprobante` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_usuario` (IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_kardex_inventario` (IN `p_mes` VARCHAR(7))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_login_usuario` (IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_print_barcode_producto` (IN `p_id` INT)  BEGIN
SELECT codigo_barra,codigo_interno,nombre_producto FROM producto WHERE idproducto = p_id;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_apartados` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_descontar_perecedero` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_fecha_vencimiento` DATE)  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_detalle_imprimir_ticket_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_sacar_vencidos` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_search_producto` (IN `p_search` VARCHAR(175))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_search_producto_apartado` (IN `p_search` VARCHAR(175))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_search_producto_cotizacion` (IN `p_search` VARCHAR(175))  BEGIN
SELECT idproducto,codigo_interno,codigo_barra,nombre_producto,siglas,nombre_marca,
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_search_producto_venta` (IN `p_search` VARCHAR(175))  BEGIN
SELECT * FROM view_productos_venta WHERE codigo_barra LIKE CONCAT('%',p_search,'%')
OR nombre_producto LIKE CONCAT('%',p_search,'%') OR codigo_interno LIKE CONCAT('%',p_search,'%')
ORDER BY idproducto DESC;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_compras` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_detalle_imprimir_ticket_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_devolver_productos_apartados` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_abono` (IN `p_idabono` INT(11), IN `p_fecha_abono` DATETIME, IN `p_monto_abono` DECIMAL(8,2))  BEGIN
UPDATE `abono`
SET  `fecha_abono` = p_fecha_abono, `monto_abono` = p_monto_abono
WHERE `idabono` = p_idabono;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_categoria` (IN `p_idcategoria` INT(11), IN `p_nombre_categoria` VARCHAR(120), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `categoria`
SET `nombre_categoria` = p_nombre_categoria, `estado` = p_estado
WHERE `idcategoria` = p_idcategoria;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_cliente` (IN `p_idcliente` INT(11), IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(8), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `cliente`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_comprobante` (IN `p_idcomprobante` INT(11), IN `p_nombre_comprobante` VARCHAR(75), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `comprobante`
SET `nombre_comprobante` = p_nombre_comprobante, `estado` = p_estado
WHERE `idcomprobante` = p_idcomprobante;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_credito` (IN `p_idcredito` INT(11), IN `p_nombre_credito` VARCHAR(120), IN `p_fecha_credito` DATETIME, IN `p_monto_credito` DECIMAL(8,2), IN `p_monto_abonado` DECIMAL(8,2), IN `p_monto_restante` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `credito`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_count_ventas` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_finalizar_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_currency` (IN `p_idcurrency` INT(11), IN `p_CurrencyISO` VARCHAR(3), IN `p_Language` VARCHAR(3), IN `p_CurrencyName` VARCHAR(35), IN `p_Money` VARCHAR(30), IN `p_Symbol` VARCHAR(3))  BEGIN
UPDATE `currency` 
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_empleado` (IN `p_idempleado` INT(11), IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(8), IN `p_email_empleado` VARCHAR(80), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `empleado`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_marca` (IN `p_idmarca` INT(11), IN `p_nombre_marca` VARCHAR(120), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `marca`
SET `nombre_marca` = p_nombre_marca, `estado` = p_estado
WHERE `idmarca` = p_idmarca;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_imprimir_ticket` (IN `p_idventa` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_imprimir_ticket_abono` (IN `p_idabono` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_monto_inicial` (IN `p_monto_apertura` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_parametro` (IN `p_idparametro` INT(11), IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(14), IN `p_porcentaje_iva` DECIMAL(8,2), IN `p_porcentaje_retencion` DECIMAL(8,2), IN `p_monto_retencion` DECIMAL(8,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))  BEGIN
UPDATE `parametro`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
  UPDATE `perecedero` SET
  `cantidad_perecedero` = p_cantidad_perecedero
   WHERE `idproducto` =  p_idproducto AND `fecha_vencimiento` = p_fecha_vencimiento;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_presentacion` (IN `p_idpresentacion` INT(11), IN `p_nombre_presentacion` VARCHAR(120), IN `p_siglas` VARCHAR(45), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `presentacion`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_proveedor` (IN `p_idproveedor` INT(11), IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(8), IN `p_numero_nit` VARCHAR(14), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `proveedor`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_imprimir_ticket_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_update_usuario` (IN `p_idusuario` INT(11), IN `p_usuario` VARCHAR(8), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_estado` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
UPDATE `usuario`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_validar_caja` ()  BEGIN
		SELECT * FROM caja WHERE DATE(fecha_apertura) = CURDATE()
        AND estado = 1;
	END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_abono` (IN `p_idcredito` INT(11), IN `p_monto_abono` DECIMAL(8,2), IN `p_idusuario` INT(11))  BEGIN
DECLARE p_codigo_credito varchar(175);
DECLARE p_monto_restante DECIMAL(8,2);
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_caja_venta` (IN `p_monto_movimiento` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_credito_venta` (IN `p_monto_credito` DECIMAL(8,2), IN `p_idcliente` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_detallecotizacion` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_disponible` TINYINT(1), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_validar_inventario` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_ventas_anual` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_abonos` (IN `p_idcredito` INT(11))  BEGIN
	SELECT * FROM view_abonos WHERE idcredito = p_idcredito;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_all_abonos` ()  BEGIN
	SELECT * FROM view_abonos;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_detalleapartado` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_categoria` ()  BEGIN
SELECT `idcategoria`, `nombre_categoria`, `estado`
FROM `categoria`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_detallecompra` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,4), IN `p_exento` DECIMAL(8,2), IN `p_fecha_vencimiento` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_detalleventa` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_categoria_activa` ()  BEGIN
SELECT `idcategoria`, `nombre_categoria`, `estado`
FROM `categoria` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_cliente` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_entrada` (IN `p_descripcion_entrada` VARCHAR(150), IN `p_cantidad_entrada` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_insert_salida` (IN `p_descripcion_salida` VARCHAR(150), IN `p_cantidad_salida` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_panel_dashboard` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_cliente_activo` ()  BEGIN
SELECT `idcliente`, `codigo_cliente`, `nombre_cliente`, `numero_nit`,
`direccion_cliente`, `numero_telefono`, `email`,
`giro`, `limite_credito`, `estado`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_cliente_inactivo` ()  BEGIN
SELECT `idcliente`, `codigo_cliente`, `nombre_cliente`, `numero_nit`,
`direccion_cliente`, `numero_telefono`, `email`,
`giro`, `limite_credito`, `estado`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_compra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_comprobante` ()  BEGIN
SELECT `idcomprobante`, `nombre_comprobante`, `estado`
FROM `comprobante`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_comprobante_activo` ()  BEGIN
SELECT `idcomprobante`, `nombre_comprobante` FROM `comprobante` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_cotizacion` (`p_fecha` DATE, `p_fecha2` DATE)  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_cotizacion_detalle` (`p_idcotizacion` INT)  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_creditos` (IN `p_criterio` TINYINT(1))  BEGIN
	SELECT * FROM view_creditos_venta WHERE estado_credito = p_criterio;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_creditos_espc` (IN `p_idcredito` INT)  BEGIN
	SELECT * FROM view_creditos_venta WHERE idcredito = p_idcredito;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_currency` ()  BEGIN
SELECT `idcurrency`, `CurrencyISO`, `Language`, `CurrencyName`, 
`Money`, `Symbol`
FROM `currency`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_datos_caja` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_detalleapartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_detallecompra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_detalleventa` (IN `p_idventa` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_devoluciones_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 2 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_empleado` ()  BEGIN
SELECT `idempleado`, `codigo_empleado`, `nombre_empleado`, `apellido_empleado`,
`telefono_empleado`, `email_empleado`, `estado`
FROM `empleado`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_empleado_activo` ()  BEGIN
SELECT `idempleado`, `codigo_empleado`, `nombre_empleado`, `apellido_empleado`,
`telefono_empleado`, `email_empleado`, `estado`
FROM `empleado` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_entradas` (IN `p_mes` VARCHAR(7))  BEGIN
    IF (p_mes!='') THEN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_gastos_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 4 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_impuesto` ()  BEGIN
SELECT `porcentaje_iva`,`porcentaje_retencion`,`monto_retencion`  FROM `parametro`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_info_cotizacion` (IN `p_idcotizacion` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_ingresos_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 1 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_limite_credito` (IN `p_idcliente` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_marca` ()  BEGIN
SELECT `idmarca`, `nombre_marca`, `estado`
FROM `marca`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_marca_activa` ()  BEGIN
SELECT `idmarca`, `nombre_marca`, `estado`
FROM `marca` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_money` ()  BEGIN
DECLARE p_idcurrency INT;
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_monto_credito` (IN `p_idcredito` INT(11))  BEGIN
	SELECT monto_restante FROM credito WHERE idcredito = p_idcredito;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_ordentaller` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_parametro` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_movimientos_caja` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_perecedero` (IN `p_desde` DATE, IN `p_hasta` DATE)  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_presentacion` ()  BEGIN
SELECT `idpresentacion`, `nombre_presentacion`, `siglas` , `estado`
FROM `presentacion`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_presentacion_activa` ()  BEGIN
SELECT `idpresentacion`, `nombre_presentacion`, `siglas` , `estado`
FROM `presentacion` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_prestamos_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 3 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto` ()  BEGIN
SELECT * FROM view_productos;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_activo` ()  BEGIN
SELECT * FROM view_productos WHERE estado = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_agotado` ()  BEGIN
SELECT * FROM view_productos WHERE stock = 0;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_inactivo` ()  BEGIN
SELECT * FROM view_productos WHERE estado = 0;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_no_perecedero` ()  BEGIN
SELECT * FROM view_productos WHERE estado = 1 AND perecedero = 0 AND  stock > 0.00 AND inventariable = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_perecedero` ()  BEGIN
SELECT * FROM view_productos WHERE estado = 1 AND perecedero = 1 AND  stock > 0.00 AND inventariable = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_producto_vigente` ()  BEGIN
SELECT * FROM view_productos WHERE  stock > 0.00;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_proveedor` ()  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_proveedor_activo` ()  BEGIN
SELECT `idproveedor`, `codigo_proveedor`, `nombre_proveedor`, `numero_telefono`,
`numero_nit`, `nombre_contacto`, `telefono_contacto`,
`estado`
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_report_ordentaller` (IN `p_id` INT)  BEGIN
	DECLARE p_idmax int;
	 IF (p_id  = '0') THEN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_salidas` (IN `p_mes` VARCHAR(7))  BEGIN
    IF (p_mes!='') THEN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_stock_producto_perecedero` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_tecnico` ()  BEGIN
	SELECT `idtecnico`, `tecnico`, `telefono`, `estado`
	FROM `tecnico`;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_tecnico_activo` ()  BEGIN
	SELECT `idtecnico`, `tecnico`, `telefono`, `estado`
	FROM `tecnico` WHERE `estado` = 1;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_tiraje` ()  BEGIN
SELECT * FROM view_comprobantes;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_tiraje_activo` ()  BEGIN
SELECT idcomprobante, nombre_comprobante FROM view_comprobantes WHERE estado = 1 AND
disponibles > 0;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_total_abonos_fechas` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_usuario` ()  BEGIN
SELECT * FROM view_usuarios;
END$$

CREATE DEFINER=`u486050466_uvent`@`localhost` PROCEDURE `sp_view_venta` (IN `p_idventa` INT(11))  BEGIN
...
(13, '2018-07-11 10:08:27', '300.00', '0.00', NULL, 1),
(14, '2018-07-12 17:09:07', '300.00', '0.00', NULL, 1),
(15, '2018-07-13 09:49:58', '500.00', '0.00', NULL, 1),
(16, '2018-07-18 20:55:06', '100.00', '0.00', NULL, 1),
(17, '2018-07-25 09:40:36', '800.00', '0.00', NULL, 0),
(18, '2018-08-02 09:08:17', '1000.00', '0.00', NULL, 0),
(19, '2018-08-07 10:10:03', '2233.00', '0.00', NULL, 1),
(20, '2018-08-08 20:34:01', '500.00', '0.00', NULL, 1),
(21, '2018-08-12 15:28:11', '12.00', '0.00', NULL, 1),
(22, '2018-08-19 10:37:51', '300.00', '0.00', NULL, 1),
(23, '2018-08-22 10:12:46', '344.00', '0.00', NULL, 1),
(24, '2018-08-23 20:24:33', '70000.00', '0.00', NULL, 1),
(25, '2018-08-24 14:14:07', '800.00', '0.00', NULL, 1),
(26, '2018-08-25 00:06:07', '7888.00', '0.00', NULL, 1),
(27, '2018-08-28 21:35:11', '7000.00', '0.00', NULL, 1),
(28, '2018-09-05 08:06:26', '3000.00', '0.00', NULL, 1),
(29, '2018-12-12 20:29:13', '5000.00', '0.00', NULL, 1),
(30, '2019-02-05 13:27:02', '20000.00', '0.00', NULL, 1),
(31, '2019-02-06 12:01:26', '7000.00', '0.00', NULL, 1),
(32, '2019-02-11 19:26:53', '5000.00', '0.00', NULL, 1),
(33, '2019-02-18 09:59:01', '12000.00', '0.00', NULL, 1),
(34, '2019-03-28 22:36:07', '200.00', '0.00', NULL, 1),
(35, '2019-07-05 12:10:48', '980.00', '0.00', NULL, 1);
...
(13, 1, '26.99', 'POR VENTA TICKET # 50', '2018-07-11'),
(13, 1, '28.07', 'POR VENTA TICKET # 51', '2018-07-11'),
(14, 1, '56.98', 'POR VENTA TICKET # 52', '2018-07-12'),
(15, 1, '56.98', 'POR VENTA TICKET # 53', '2018-07-13'),
(16, 1, '29.99', 'POR VENTA TICKET # 54', '2018-07-18'),
(18, 1, '26.99', 'POR VENTA TICKET # 55', '2018-08-02'),
(18, 1, '29.99', 'POR VENTA TICKET # 56', '2018-08-02'),
(18, 1, '26.99', 'POR VENTA FACTURA # 1', '2018-08-02'),
(20, 1, '26.99', 'POR VENTA TICKET # 57', '2018-08-08'),
(25, 1, '29.99', 'POR VENTA FACTURA # 2', '2018-08-24'),
(25, 1, '26.99', 'POR VENTA TICKET # 58', '2018-08-24'),
(25, 1, '26.99', 'POR VENTA TICKET # 59', '2018-08-24'),
(25, 1, '29.99', 'POR VENTA TICKET # 60', '2018-08-24'),
(25, 1, '50.99', 'POR VENTA TICKET # 61', '2018-08-24'),
(25, 1, '56.98', 'POR VENTA TICKET # 62', '2018-08-24'),
(25, 1, '5.85', 'POR VENTA TICKET # 63', '2018-08-24'),
(25, 1, '26.99', 'POR VENTA TICKET # 64', '2018-08-24'),
(25, 1, '29.99', 'POR VENTA FACTURA # 3', '2018-08-24'),
(27, 1, '56.84', 'POR VENTA TICKET # 65', '2018-08-28'),
(28, 1, '83.97', 'POR VENTA TICKET # 66', '2018-09-05'),
(29, 1, '24.00', 'POR VENTA TICKET # 63', '2018-12-12'),
(30, 1, '24.00', 'POR VENTA TICKET # 64', '2019-02-05'),
(32, 1, '24.00', 'POR VENTA TICKET # 65', '2019-02-11'),
(33, 1, '53.99', 'POR VENTA TICKET # 66', '2019-02-18'),
(34, 1, '53.99', 'POR VENTA TICKET # 67', '2019-03-28'),
(35, 1, '24.00', 'POR VENTA TICKET # 68', '2019-07-05'),
(35, 1, '29.99', 'POR VENTA TICKET # 69', '2019-07-05'),
(35, 1, '26.99', 'POR VENTA TICKET # 70', '2019-07-05'),
(35, 1, '5.85', 'POR VENTA TICKET # 71', '2019-07-05'),
(35, 1, '5.85', 'POR VENTA TICKET # 72', '2019-07-05');
...
(3, '2018-07-12 16:12:00', 1, '1', '23444', '2', '2018-07-13', '14.75', '2.65', '0.00', '0.00', '17.41', 'DIECISIETE 41/100 USD', 1),
(4, '2018-07-18 19:57:22', 1, '1', '90829', '1', '2018-07-18', '2.75', '0.50', '13.99', '0.00', '17.24', 'DIECISIETE 24/100 USD', 1),
(5, '2018-08-07 08:59:46', 1, '1', '12434', '1', '2018-08-08', '2.75', '0.50', '13.99', '0.00', '17.24', 'DIECISIETE 24/100 USD', 1),
(6, '2018-08-24 14:07:32', 1, '1', '7888', '1', '2018-08-24', '0.00', '0.00', '13.99', '0.00', '13.99', 'TRECE 99/100 USD', 1),
(7, '2018-08-28 20:37:04', 1, '1', '9879', '1', '2018-08-28', '12.00', '2.16', '15.00', '0.00', '29.16', 'VEINTINUEVE 16/100 USD', 1),
(8, '2018-09-05 07:10:45', 1, '1', '98786', '1', '2018-09-06', '2.75', '0.44', '15.00', '0.00', '18.19', 'DIECIOCHO 19/100 USD', 1),
(9, '2019-02-11 18:33:20', 1, '1', '09789', '1', '2019-02-12', '2.75', '0.44', '0.00', '0.00', '3.19', 'TRES 19/100 USD', 1),
(10, '2019-02-11 18:35:54', 1, '1', '787687', '1', '2019-02-12', '2.75', '0.44', '13.99', '0.00', '17.18', 'DIECISIETE 18/100 USD', 1);
...
(2, 'COTI00000002', '2018-08-28 21:41:02', 'DIANA ZAMORA', 'AL CONTADO', 'INMEDIATA', '41.38', '6.62', '26.99', '0.00', '26.99', '48.00', 'Cuarenta y ocho 00/100 USD', 1, 1);
...
(7, 'PEN', 'ES', 'Sol Peruano', 'SOLES', 'S/'),
(8, 'CL', 'ES', 'Peso chileno', 'PESOS', '$');
...
(3, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(3, 4, NULL, '1.00', '12.0000', '0.00', '12.00'),
(4, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(4, 2, NULL, '1.00', '13.9900', '13.99', '13.99'),
(5, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(5, 2, NULL, '1.00', '13.9900', '13.99', '13.99'),
(6, 2, NULL, '1.00', '13.9900', '13.99', '13.99'),
(7, 4, NULL, '1.00', '12.0000', '0.00', '12.00'),
(7, 5, '2018-09-07', '1.00', '15.0000', '15.00', '15.00'),
(8, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(8, 5, '2018-09-15', '1.00', '15.0000', '15.00', '15.00'),
(9, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(10, 1, NULL, '1.00', '2.7500', '0.00', '2.75'),
(10, 2, NULL, '1.00', '13.9900', '13.99', '13.99');
...
(2, 4, '2.00', 1, '24.00', '0.00', '0.00', '48.00'),
(2, 5, '1.00', 1, '26.99', '26.99', '0.00', '26.99');
...
(50, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(51, 5, '1.04', '26.99', NULL, '28.07', '0.00', '28.07'),
(52, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(52, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(53, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(53, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(54, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(55, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(56, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(57, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(58, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(59, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(60, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(61, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(62, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(63, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(63, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(64, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(64, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(65, 1, '1.00', '5.85', NULL, '0.00', '0.00', '5.85'),
(66, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(67, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(68, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(68, 5, '1.00', '26.99', '2018-09-01', '26.99', '0.00', '26.99'),
(68, 1, '1.00', '5.85', NULL, '0.00', '0.00', '5.85'),
(69, 5, '1.00', '26.99', '2018-09-07', '26.99', '0.00', '26.99'),
(69, 5, '1.00', '26.99', '2018-09-07', '26.99', '0.00', '26.99'),
(69, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(70, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(71, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(72, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(73, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(73, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(74, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(74, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(75, 4, '1.00', '24.00', NULL, '0.00', '0.00', '24.00'),
(76, 2, '1.00', '29.99', NULL, '29.99', '0.00', '29.99'),
(77, 5, '1.00', '26.99', NULL, '26.99', '0.00', '26.99'),
(78, 1, '1.00', '5.85', NULL, '0.00', '0.00', '5.85'),
(79, 1, '1.00', '5.85', NULL, '0.00', '0.00', '5.85');
...
(8, '2018-07', '2018-07-12', 'POR COMPRA FACTURA # 23444', '1.00', '2.75', '2.75', 1, 3, NULL),
(9, '2018-07', '2018-07-12', 'POR COMPRA FACTURA # 23444', '1.00', '12.00', '12.00', 4, 3, NULL),
(10, '2018-07', '2018-07-18', 'POR COMPRA TICKET # 90829', '1.00', '2.75', '2.75', 1, 4, NULL),
(11, '2018-07', '2018-07-18', 'POR COMPRA TICKET # 90829', '1.00', '13.99', '13.99', 2, 4, NULL),
(12, '2018-08', '2018-08-07', 'POR COMPRA TICKET # 12434', '1.00', '2.75', '2.75', 1, 5, NULL),
(13, '2018-08', '2018-08-07', 'POR COMPRA TICKET # 12434', '1.00', '13.99', '13.99', 2, 5, NULL),
(14, '2018-08', '2018-08-12', 'POR AJUSTE DE INVENTARIO', '1.00', '13.99', '13.99', 2, NULL, NULL),
(15, '2018-08', '2018-08-12', 'POR AJUSTE DE INVENTARIO', '2.00', '13.99', '27.98', 2, NULL, NULL),
(16, '2018-08', '2018-08-24', 'POR COMPRA TICKET # 7888', '1.00', '13.99', '13.99', 2, 6, NULL),
(17, '2018-08', '2018-08-28', 'POR COMPRA TICKET # 9879', '1.00', '12.00', '12.00', 4, 7, NULL),
(18, '2018-08', '2018-08-28', 'POR COMPRA TICKET # 9879', '1.00', '15.00', '15.00', 5, 7, NULL),
(19, '2018-09', '2018-09-05', 'POR COMPRA TICKET # 98786', '1.00', '2.75', '2.75', 1, 8, NULL),
(20, '2018-09', '2018-09-05', 'POR COMPRA TICKET # 98786', '1.00', '15.00', '15.00', 5, 8, NULL),
(21, '2019-02', '2019-02-11', 'POR COMPRA TICKET # 09789', '1.00', '2.75', '2.75', 1, 9, NULL),
(22, '2019-02', '2019-02-11', 'POR COMPRA TICKET # 787687', '1.00', '2.75', '2.75', 1, 10, NULL),
(23, '2019-02', '2019-02-11', 'POR COMPRA TICKET # 787687', '1.00', '13.99', '13.99', 2, 10, NULL);
...
('2017-12', '2017-12-01', '2017-12-31', '249.00', '0.00', '12.00', '237.00', 0, 1),
('2017-12', '2017-12-01', '2017-12-31', '103.00', '0.00', '20.00', '83.00', 0, 2),
('2017-12', '2017-12-01', '2017-12-31', '11.00', '0.00', '11.00', '0.00', 0, 3),
('2017-12', '2017-12-01', '2017-12-31', '33.00', '0.00', '11.00', '22.00', 0, 4),
('2017-12', '2017-12-01', '2017-12-31', '60.00', '0.00', '28.00', '32.00', 0, 5),
('2018-07', '2018-07-01', '2018-07-31', '237.00', '2.00', '0.00', '239.00', 0, 1),
('2018-07', '2018-07-01', '2018-07-31', '83.00', '1.00', '3.00', '81.00', 0, 2),
('2018-07', '2018-07-01', '2018-07-31', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2018-07', '2018-07-01', '2018-07-31', '22.00', '1.00', '0.00', '23.00', 0, 4),
('2018-07', '2018-07-01', '2018-07-31', '32.00', '0.00', '4.04', '27.96', 0, 5),
('2018-08', '2018-08-01', '2018-08-31', '239.00', '1.00', '2.00', '238.00', 0, 1),
('2018-08', '2018-08-01', '2018-08-31', '81.00', '5.00', '5.00', '81.00', 0, 2),
('2018-08', '2018-08-01', '2018-08-31', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2018-08', '2018-08-01', '2018-08-31', '23.00', '1.00', '2.00', '22.00', 0, 4),
('2018-08', '2018-08-01', '2018-08-31', '27.96', '1.00', '9.00', '19.96', 0, 5),
('2018-09', '2018-09-01', '2018-09-30', '238.00', '1.00', '0.00', '239.00', 0, 1),
('2018-09', '2018-09-01', '2018-09-30', '81.00', '0.00', '1.00', '80.00', 0, 2),
('2018-09', '2018-09-01', '2018-09-30', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2018-09', '2018-09-01', '2018-09-30', '22.00', '0.00', '0.00', '22.00', 0, 4),
('2018-09', '2018-09-01', '2018-09-30', '19.96', '1.00', '2.00', '18.96', 0, 5),
('2018-12', '2018-12-01', '2018-12-31', '239.00', '0.00', '2.00', '237.00', 0, 1),
('2018-12', '2018-12-01', '2018-12-31', '80.00', '0.00', '0.00', '80.00', 0, 2),
('2018-12', '2018-12-01', '2018-12-31', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2018-12', '2018-12-01', '2018-12-31', '22.00', '0.00', '1.00', '21.00', 0, 4),
('2018-12', '2018-12-01', '2018-12-31', '18.96', '0.00', '0.00', '18.96', 0, 5),
('2019-02', '2019-02-01', '2019-02-28', '237.00', '2.00', '0.00', '239.00', 0, 1),
('2019-02', '2019-02-01', '2019-02-28', '80.00', '1.00', '1.00', '80.00', 0, 2),
('2019-02', '2019-02-01', '2019-02-28', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2019-02', '2019-02-01', '2019-02-28', '21.00', '0.00', '3.00', '18.00', 0, 4),
('2019-02', '2019-02-01', '2019-02-28', '18.96', '0.00', '0.00', '18.96', 0, 5),
('2019-03', '2019-03-01', '2019-03-31', '239.00', '0.00', '0.00', '239.00', 0, 1),
('2019-03', '2019-03-01', '2019-03-31', '80.00', '0.00', '1.00', '79.00', 0, 2),
('2019-03', '2019-03-01', '2019-03-31', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2019-03', '2019-03-01', '2019-03-31', '18.00', '0.00', '1.00', '17.00', 0, 4),
('2019-03', '2019-03-01', '2019-03-31', '18.96', '0.00', '0.00', '18.96', 0, 5),
('2019-07', '2019-07-01', '2019-07-31', '239.00', '0.00', '2.00', '237.00', 1, 1),
('2019-07', '2019-07-01', '2019-07-31', '79.00', '0.00', '1.00', '78.00', 1, 2),
('2019-07', '2019-07-01', '2019-07-31', '0.00', '0.00', '0.00', '0.00', 1, 3),
('2019-07', '2019-07-01', '2019-07-31', '17.00', '0.00', '1.00', '16.00', 1, 4),
('2019-07', '2019-07-01', '2019-07-31', '18.96', '0.00', '1.00', '17.96', 1, 5);
...
(1, 'NOMBRE DE LA EMPRESA', 'SOLUCIONES INFORMATICA', '20305763', '16.00', '0.00', '0.00', '3RA CALLE ZONA 2 YEPOCAPA', NULL, 7);
...
(2, 'PR00000002', '0008808484', 'JUEGO TECLADO / MOUSE GAMING COD 0008808484', '13.99', '29.99', '28.99', '78.00', '2.00', 1, 1, 1, 1, 1, 1, 0),
(3, 'PR00000003', '00088484881', 'MICRO SD BLACK DISK 32 GB', '3.50', '100.00', '14.99', '0.00', '6.00', 1, 1, 1, 1, 0, 1, 0),
(4, 'PR00000004', '0008848488', 'SHAMPO ALOE VERA NATURAL COD 0008848488332', '12.00', '24.00', '20.00', '16.00', '5.00', 1, 1, 1, 1, 0, 1, 0),
(5, 'PR00000005', '1234567689', 'PEPTO BISMOL 12ML', '15.00', '26.99', '25.00', '17.96', '3.00', 1, 1, 1, 1, 1, 1, 1);
...
(1, 1, '2018-07-12', '2.7500'),
(1, 4, '2018-07-12', '12.0000'),
(1, 1, '2018-07-18', '2.7500'),
(1, 2, '2018-07-18', '13.9900'),
(1, 1, '2018-08-07', '2.7500'),
(1, 2, '2018-08-07', '13.9900'),
(1, 2, '2018-08-24', '13.9900'),
(1, 4, '2018-08-28', '12.0000'),
(1, 5, '2018-08-28', '15.0000'),
(1, 1, '2018-09-05', '2.7500'),
(1, 5, '2018-09-05', '15.0000'),
(1, 1, '2019-02-11', '2.7500'),
(1, 1, '2019-02-11', '2.7500'),
(1, 2, '2019-02-11', '13.9900');
...
(99, '2018-07', '2018-07-11', 'POR VENTA TICKET # 50', '1.00', '15.00', '15.00', 5, 50, NULL),
(100, '2018-07', '2018-07-11', 'POR VENTA TICKET # 51', '1.04', '15.00', '15.60', 5, 51, NULL),
(101, '2018-07', '2018-07-12', 'POR VENTA TICKET # 52', '1.00', '13.99', '13.99', 2, 52, NULL),
(102, '2018-07', '2018-07-12', 'POR VENTA TICKET # 52', '1.00', '15.00', '15.00', 5, 52, NULL),
(103, '2018-07', '2018-07-13', 'POR VENTA TICKET # 53', '1.00', '13.99', '13.99', 2, 53, NULL),
(104, '2018-07', '2018-07-13', 'POR VENTA TICKET # 53', '1.00', '15.00', '15.00', 5, 53, NULL),
(105, '2018-07', '2018-07-18', 'POR VENTA TICKET # 54', '1.00', '13.99', '13.99', 2, 54, NULL),
(106, '2018-08', '2018-08-02', 'POR VENTA TICKET # 55', '1.00', '15.00', '15.00', 5, 55, NULL),
(107, '2018-08', '2018-08-02', 'POR VENTA TICKET # 56', '1.00', '13.99', '13.99', 2, 56, NULL),
(108, '2018-08', '2018-08-02', 'POR VENTA FACTURA # 1', '1.00', '15.00', '15.00', 5, 57, NULL),
(109, '2018-08', '2018-08-08', 'POR VENTA TICKET # 57', '1.00', '15.00', '15.00', 5, 58, NULL),
(110, '2018-08', '2018-08-24', 'POR VENTA FACTURA # 2', '1.00', '13.99', '13.99', 2, 59, NULL),
(111, '2018-08', '2018-08-24', 'POR VENTA TICKET # 58', '1.00', '15.00', '15.00', 5, 60, NULL),
(112, '2018-08', '2018-08-24', 'POR VENTA TICKET # 59', '1.00', '15.00', '15.00', 5, 61, NULL),
(113, '2018-08', '2018-08-24', 'POR VENTA TICKET # 60', '1.00', '13.99', '13.99', 2, 62, NULL),
(114, '2018-08', '2018-08-24', 'POR VENTA TICKET # 61', '1.00', '15.00', '15.00', 5, 63, NULL),
(115, '2018-08', '2018-08-24', 'POR VENTA TICKET # 61', '1.00', '12.00', '12.00', 4, 63, NULL),
(116, '2018-08', '2018-08-24', 'POR VENTA TICKET # 62', '1.00', '15.00', '15.00', 5, 64, NULL),
(117, '2018-08', '2018-08-24', 'POR VENTA TICKET # 62', '1.00', '13.99', '13.99', 2, 64, NULL),
(118, '2018-08', '2018-08-24', 'POR VENTA TICKET # 63', '1.00', '2.75', '2.75', 1, 65, NULL),
(119, '2018-08', '2018-08-24', 'POR VENTA TICKET # 64', '1.00', '15.00', '15.00', 5, 66, NULL),
(120, '2018-08', '2018-08-24', 'POR VENTA FACTURA # 3', '1.00', '13.99', '13.99', 2, 67, NULL),
(121, '2018-08', '2018-08-28', 'POR VENTA TICKET # 65', '1.00', '12.00', '12.00', 4, 68, NULL),
(122, '2018-08', '2018-08-28', 'POR VENTA TICKET # 65', '1.00', '15.00', '15.00', 5, 68, NULL),
(123, '2018-08', '2018-08-28', 'POR VENTA TICKET # 65', '1.00', '2.75', '2.75', 1, 68, NULL),
(124, '2018-09', '2018-09-05', 'POR VENTA TICKET # 66', '1.00', '15.00', '15.00', 5, 69, NULL),
(125, '2018-09', '2018-09-05', 'POR VENTA TICKET # 66', '1.00', '15.00', '15.00', 5, 69, NULL),
(126, '2018-09', '2018-09-05', 'POR VENTA TICKET # 66', '1.00', '13.99', '13.99', 2, 69, NULL),
(127, '2018-12', '2018-12-12', 'POR AVERIA DE PRODUCTO', '2.00', '2.75', '5.50', 1, NULL, NULL),
(128, '2018-12', '2018-12-12', 'POR VENTA TICKET # 63', '1.00', '12.00', '12.00', 4, 70, NULL),
(129, '2019-02', '2019-02-05', 'POR VENTA TICKET # 64', '1.00', '12.00', '12.00', 4, 71, NULL),
(130, '2019-02', '2019-02-11', 'POR VENTA TICKET # 65', '1.00', '12.00', '12.00', 4, 72, NULL),
(131, '2019-02', '2019-02-18', 'POR VENTA TICKET # 66', '1.00', '12.00', '12.00', 4, 73, NULL),
(132, '2019-02', '2019-02-18', 'POR VENTA TICKET # 66', '1.00', '13.99', '13.99', 2, 73, NULL),
(133, '2019-03', '2019-03-28', 'POR VENTA TICKET # 67', '1.00', '12.00', '12.00', 4, 74, NULL),
(134, '2019-03', '2019-03-28', 'POR VENTA TICKET # 67', '1.00', '13.99', '13.99', 2, 74, NULL),
(135, '2019-07', '2019-07-05', 'POR VENTA TICKET # 68', '1.00', '12.00', '12.00', 4, 75, NULL),
(136, '2019-07', '2019-07-05', 'POR VENTA TICKET # 69', '1.00', '13.99', '13.99', 2, 76, NULL),
(137, '2019-07', '2019-07-05', 'POR VENTA TICKET # 70', '1.00', '15.00', '15.00', 5, 77, NULL),
(138, '2019-07', '2019-07-05', 'POR VENTA TICKET # 71', '1.00', '2.75', '2.75', 1, 78, NULL),
(139, '2019-07', '2019-07-05', 'POR VENTA TICKET # 72', '1.00', '2.75', '2.75', 1, 79, NULL);
...
(1, '2017-08-31', 'RES 008458148', '2017-1-199999', 'A', 1, 5000, 1, 4928),
(2, '2018-08-03', '2018-01-0008', '2018-01-0008', '15UN000000001 1615UN0000001', 100000, 2000000, 2, 1999997);
...
(50, 'V00000050', '2018-07-11 20:31:19', 'EFECTIVO', 50, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '30.00', '0.00', '', '', '3.01', 1, 1, 1),
(51, 'V00000051', '2018-07-11 20:46:32', 'EFECTIVO', 51, 1, '0.00', '0.00', '28.07', '0.00', '0.00', '28.07', 'Veintiocho 07/100 USD', '40.00', '0.00', '', '', '11.93', 1, 1, 1),
(52, 'V00000052', '2018-07-12 17:10:17', 'EFECTIVO', 52, 1, '0.00', '0.00', '56.98', '0.00', '0.00', '56.98', 'Cincuenta y seis 98/100 USD', '60.00', '0.00', '', '', '3.02', 1, 1, 1),
(53, 'V00000053', '2018-07-13 09:50:53', 'EFECTIVO', 53, 1, '0.00', '0.00', '56.98', '0.00', '0.00', '56.98', 'Cincuenta y seis 98/100 USD', '70.00', '0.00', '', '', '13.02', 1, 1, 1),
(54, 'V00000054', '2018-07-18 20:56:48', 'EFECTIVO', 54, 1, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '50.00', '0.00', '', '', '20.01', 1, 1, 1),
(55, 'V00000055', '2018-08-02 09:08:42', 'EFECTIVO', 55, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '30.00', '0.00', '', '', '3.01', 1, NULL, 1),
(56, 'V00000056', '2018-08-02 09:16:50', 'EFECTIVO', 56, 1, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '30.00', '0.00', '', '', '0.01', 1, 1, 1),
(57, 'V00000057', '2018-08-02 09:38:41', 'EFECTIVO', 1, 2, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '30.00', '0.00', '', '', '3.01', 1, 1, 1),
(58, 'V00000058', '2018-08-08 20:39:32', 'EFECTIVO', 57, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '50.00', '0.00', '', '', '23.01', 1, 1, 1),
(59, 'V00000059', '2018-08-24 14:14:31', 'EFECTIVO', 2, 2, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '80.00', '0.00', '', '', '50.01', 1, NULL, 1),
(60, 'V00000060', '2018-08-24 14:47:49', 'EFECTIVO', 58, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '80.00', '0.00', '', '', '53.01', 1, NULL, 1),
(61, 'V00000061', '2018-08-24 14:59:10', 'EFECTIVO', 59, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '80.00', '0.00', '', '', '53.01', 1, NULL, 1),
(62, 'V00000062', '2018-08-24 15:03:41', 'EFECTIVO', 60, 1, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '60.00', '0.00', '', '', '30.01', 1, 1, 1),
(63, 'V00000063', '2018-08-24 15:04:24', 'EFECTIVO', 61, 1, '20.34', '3.66', '26.99', '0.00', '0.00', '50.99', 'Cincuenta 99/100 USD', '70.00', '0.00', '', '', '19.01', 1, 1, 1),
(64, 'V00000064', '2018-08-24 15:06:06', 'EFECTIVO', 62, 1, '0.00', '0.00', '56.98', '0.00', '0.00', '56.98', 'Cincuenta y seis 98/100 USD', '60.00', '0.00', '', '', '3.02', 1, 1, 1),
(65, 'V00000065', '2018-08-24 15:07:54', 'EFECTIVO', 63, 1, '4.96', '0.89', '0.00', '0.00', '0.00', '5.85', 'Cinco 85/100 USD', '90.00', '0.00', '', '', '84.15', 1, NULL, 1),
(66, 'V00000066', '2018-08-24 16:20:52', 'EFECTIVO', 64, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '40.00', '0.00', '', '', '13.01', 1, NULL, 1),
(67, 'V00000067', '2018-08-24 16:22:04', 'EFECTIVO', 3, 2, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '50.00', '0.00', '', '', '20.01', 1, NULL, 1),
(68, 'V00000068', '2018-08-28 21:36:10', 'EFECTIVO', 65, 1, '25.30', '4.55', '26.99', '0.00', '0.00', '56.84', 'Cincuenta y seis 84/100 USD', '60.00', '56.84', '', '', '3.16', 1, 1, 1),
(69, 'V00000069', '2018-09-05 08:08:48', 'EFECTIVO', 66, 1, '0.00', '0.00', '83.97', '0.00', '0.00', '83.97', 'Ochenta y tres 97/100 USD', '100.00', '0.00', '', '', '16.03', 1, 1, 1),
(70, 'V00000070', '2018-12-12 20:32:10', 'EFECTIVO', 63, 1, '20.69', '3.31', '0.00', '0.00', '0.00', '24.00', 'Veinticuatro 00/100 USD', '24.00', '24.00', '', '', '0.00', 1, NULL, 1),
(71, 'V00000071', '2019-02-05 13:28:45', 'EFECTIVO', 64, 1, '20.69', '3.31', '0.00', '0.00', '0.00', '24.00', 'Veinticuatro 00/100 USD', '30.00', '0.00', '', '', '6.00', 1, NULL, 1),
(72, 'V00000072', '2019-02-11 19:27:48', 'EFECTIVO', 65, 1, '20.69', '3.31', '0.00', '0.00', '0.00', '24.00', 'Veinticuatro 00/100 USD', '50.00', '24.00', '', '', '26.00', 1, NULL, 1),
(73, 'V00000073', '2019-02-18 09:59:51', 'EFECTIVO', 66, 1, '20.69', '3.31', '29.99', '0.00', '0.00', '53.99', 'Cincuenta y tres 99/100 USD', '60.00', '53.99', '', '', '6.01', 1, NULL, 1),
(74, 'V00000074', '2019-03-28 22:37:21', 'EFECTIVO', 67, 1, '20.69', '3.31', '29.99', '0.00', '0.00', '53.99', 'Cincuenta y tres 99/100 USD', '60.00', '0.00', '', '', '6.01', 1, 1, 1),
(75, 'V00000075', '2019-07-05 12:11:25', 'EFECTIVO', 68, 1, '20.69', '3.31', '0.00', '0.00', '0.00', '24.00', 'Veinticuatro 00/100 USD', '24.00', '0.00', '', '', '0.00', 1, 1, 1),
(76, 'V00000076', '2019-07-05 12:19:39', 'EFECTIVO', 69, 1, '0.00', '0.00', '29.99', '0.00', '0.00', '29.99', 'Veintinueve 99/100 USD', '30.00', '0.00', '', '', '0.01', 1, 1, 1),
(77, 'V00000077', '2019-07-05 12:34:08', 'EFECTIVO', 70, 1, '0.00', '0.00', '26.99', '0.00', '0.00', '26.99', 'Veintiseis 99/100 USD', '30.00', '0.00', '', '', '3.01', 1, 1, 1),
(78, 'V00000078', '2019-07-05 12:36:32', 'EFECTIVO', 71, 1, '5.04', '0.81', '0.00', '0.00', '0.00', '5.85', 'Cinco 85/100 USD', '8.00', '0.00', '', '', '2.15', 1, 1, 1),
(79, 'V00000079', '2019-07-05 12:38:14', 'EFECTIVO', 72, 1, '5.04', '0.81', '0.00', '0.00', '0.00', '5.85', 'Cinco 85/100 USD', '8.00', '0.00', '', '', '2.15', 1, 1, 1);
...
--
ALTER TABLE `currency`
  MODIFY `idcurrency` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `entrada`
  MODIFY `identrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `salida`
  MODIFY `idsalida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
--
...
--
ALTER TABLE `tiraje_comprobante`
  MODIFY `idtiraje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
-- Eventos
--
CREATE DEFINER=`u486050466_uvent`@`localhost` EVENT `Anular_Apartados` ON SCHEDULE EVERY 1 DAY STARTS '2017-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_devolver_productos_apartados()$$

CREATE DEFINER=`u486050466_uvent`@`localhost` EVENT `Sacar_Vencidos` ON SCHEDULE EVERY 1 DAY STARTS '2017-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_sacar_vencidos()$$

CREATE DEFINER=`u486050466_uvent`@`localhost` EVENT `Cerrar_Inventario` ON SCHEDULE EVERY 1 DAY STARTS '2017-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_cerrar_inventario()$$
